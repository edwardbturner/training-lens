...
class HuggingFaceIntegration:
    ...
    def create_model_card(
        ...
        model_card_content = self._generate_model_card(
            training_config, training_metrics, model_description
        )
...
This model was trained using Training Lens, which provides comprehensive monitoring and analysis of the training process.
