...
from ..utils.helpers import get_memory_usage, get_gpu_memory_usage
...
class MetricsCollector:
    ...
    def get_gradient_cosine_similarity_trend(self, window_size: int = 10) -> Dict[str, Any]:
        ...
        return {
            ...
            "trend_direction": "increasing" if len(recent_similarities) > 1 and recent_similarities[-1] > recent_similarities[0] else "decreasing",
    ...
    def export_metrics_summary(self) -> Dict[str, Any]:
        ...
        grad_norms = [self.step_metrics[step].get("grad_norm", 0) for step in steps if "grad_norm" in self.step_metrics[step]]
