...
class CollectionManager:
    ...
    def collect_all(self, model: torch.nn.Module, step: int, **kwargs) -> Dict[DataType, Any]:
    ...
    def get_collected_data(
        self, data_types: Optional[List[DataType]] = None, steps: Optional[List[int]] = None
    ...
    def get_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "collectors": {
                data_type.value: collector.get_metadata() for data_type, collector in self.collectors.items()
            },
...
class AnalysisManager:
    ...
    def analyze_all(
        self, collected_data: Dict[int, Dict[DataType, Any]], output_dir: Optional[Path] = None
    ) -> Dict[DataType, Any]:
    ...
    def _flatten_collected_data(self, collected_data: Dict[int, Dict[DataType, Any]]) -> Dict[DataType, Any]:
    ...
    def _sort_analyzers_by_dependencies(self) -> List[DataAnalyzer]:
        ...
        while remaining_analyzers:
            ...
            for analyzer in remaining_analyzers:
                ...
                if all(any(isinstance(a, dep) for a in sorted_analyzers) for dep in dependencies):
    ...
    def get_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "analyzers": {data_type.value: analyzer.get_metadata() for data_type, analyzer in self.analyzers.items()},
