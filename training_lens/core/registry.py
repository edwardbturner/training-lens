...
class CollectorRegistry:
    ...
    def create_all_collectors(
        cls, 
        config: Optional[Dict[DataType, Dict]] = None
    ) -> List[DataCollector]:
        ...
        for py_file in package_path.glob("**/*.py"):
            ...
            try:
                ...
                for name, obj in inspect.getmembers(module, inspect.isclass):
                    if (issubclass(obj, DataCollector) and 
                        obj != DataCollector and 
    ...
    def auto_discover(cls, package_path: Union[str, Path]) -> None:
        ...
        for py_file in package_path.glob("**/*.py"):
            ...
            try:
                ...
                for name, obj in inspect.getmembers(module, inspect.isclass):
                    if (issubclass(obj, DataAnalyzer) and 
                        obj != DataAnalyzer and 
                        not inspect.isabstract(obj)):
                        cls.register(obj)
